// Generated from /Users/jiangdadong/CodeBuddy/antlr-demo01/src/main/antlr4/sparksql/SparkSqlLexer.g4 by ANTLR 4.13.1
...
public class SparkSqlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"COLUMN", "COLUMNS", "INDEX", "PRIMARY", "KEY", "UNIQUE", "NULL_", "DEFAULT", 
			"IF_", "EXISTS", "DATABASE", "SCHEMA", "ORDER", "BY", "GROUP", "HAVING", 
			"LIMIT", "OFFSET", "JOIN", "INNER", "LEFT", "RIGHT", "OUTER", "CROSS", 
			"FULL", "SEMI", "ANTI", "ON", "AS", "IN", "BETWEEN", "LIKE", "RLIKE", 
			"REGEXP", "IS", "DISTINCT", "UNION", "INTERSECT", "EXCEPT", "ALL", "CASE", 
			"WHEN", "THEN", "ELSE", "END", "ASC", "DESC", "WITH", "RECURSIVE", "TRUE", 
			"FALSE", "COUNT", "SUM", "AVG", "MIN", "MAX", "CAST", "COALESCE", "USE_", 
			"SHOW", "DATABASES", "SCHEMAS", "TABLES", "VIEWS", "FUNCTIONS", "DESCRIBE", 
			"EXTENDED", "FORMATTED", "VIEW", "TEMPORARY", "GLOBAL", "EXTERNAL", "LOCATION", 
			"STORED", "ROW", "FORMAT", "DELIMITED", "FIELDS", "TERMINATED", "LINES", 
			"TBLPROPERTIES", "SERDEPROPERTIES", "SERDE", "USING", "OPTIONS", "PARTITIONED", 
			"PARTITION", "CLUSTERED", "SORTED", "BUCKETS", "OVERWRITE", "DIRECTORY", 
			"LOCAL", "LATERAL", "WINDOW", "OVER", "ROWS", "RANGE", "UNBOUNDED", "PRECEDING", 
			"FOLLOWING", "CURRENT", "PIVOT", "UNPIVOT", "FOR", "TABLESAMPLE", "PERCENT", 
			"DISTRIBUTE", "SORT", "CLUSTER", "EXPLAIN", "CACHE", "UNCACHE", "LAZY", 
			"REFRESH", "MSCK", "REPAIR", "RECOVER", "PARTITIONS", "MAP", "STRUCT", 
			"ARRAY", "COMMENT", "RENAME", "TO", "REPLACE", "CASCADE", "RESTRICT", 
			"TINYINT", "SMALLINT", "INT", "INTEGER", "BIGINT", "FLOAT", "DOUBLE", 
			"DECIMAL", "DEC", "NUMERIC", "STRING", "CHAR", "VARCHAR", "BINARY", "BOOLEAN", 
			"DATE", "TIMESTAMP", "INTERVAL", "STAR", "COMMA", "DOT", "LPAREN", "RPAREN", 
			"LBRACKET", "RBRACKET", "SEMICOLON", "EQ", "NEQ", "LT", "GT", "LTE", 
			"GTE", "PLUS", "MINUS", "DIVIDE", "MOD", "AMPERSAND", "PIPE", "CARET", 
			"TILDE", "CONCAT", "COLON", "BACKTICK", "INTEGER_LITERAL", "DECIMAL_LITERAL", 
			"STRING_LITERAL", "BACKTICK_QUOTED_ID", "IDENTIFIER", "WS", "LINE_COMMENT", 
			"BLOCK_COMMENT", "DIGIT", "A", "B", "C", "D", "E", "F", "G", "H", "I", 
	...
	@Override
	public String getGrammarFileName() { return "SparkSqlLexer.g4"; }
