// Generated from /Users/jiangdadong/CodeBuddy/antlr-demo01/src/main/antlr4/postgresql/PostgreSqlLexer.g4 by ANTLR 4.13.1
...
public class PostgreSqlLexer extends Lexer {
	...
	public static final int
		...
		IDENTIFIER=154, WS=155, LINE_COMMENT=156, BLOCK_COMMENT=157;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"COLUMN", "INDEX", "PRIMARY", "KEY", "FOREIGN", "REFERENCES", "UNIQUE", 
			"NULL_", "DEFAULT", "IF_", "EXISTS", "DATABASE", "SCHEMA", "ORDER", "BY", 
			"GROUP", "HAVING", "LIMIT", "OFFSET", "JOIN", "INNER", "LEFT", "RIGHT", 
			"OUTER", "CROSS", "FULL", "ON", "AS", "IN", "BETWEEN", "LIKE", "ILIKE", 
			"IS", "DISTINCT", "UNION", "INTERSECT", "EXCEPT", "ALL", "CASE", "WHEN", 
			"THEN", "ELSE", "END", "ASC", "DESC", "RETURNING", "WITH", "RECURSIVE", 
			"CASCADE", "RESTRICT", "CONSTRAINT", "CHECK", "NULLS", "FIRST", "LAST", 
			"COUNT", "SUM", "AVG", "MIN", "MAX", "CAST", "COALESCE", "TRUE", "FALSE", 
			"SERIAL", "BIGSERIAL", "SMALLSERIAL", "RETURNING_KW", "CONCURRENTLY", 
